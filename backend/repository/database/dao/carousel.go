 ...
 * @LastEditTime: 2024-04-13 13:05:30
...
func (dao *CarouselDao) CreateCarousel(carousel *model.Carousel) (err error) {
	err = dao.DB.Model(&model.Carousel{}).Create(&carousel).Error
	return
}

func (dao *CarouselDao) ListCarousels() (carousels []*model.Carousel, err error) {
